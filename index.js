...
let h1 = React.createElement("h1", {style: {fontSize: '3.5rem', fontWeight: '600'}}, "Learn Web Development");
...
const container = React.createElement("div", {style : {padding: '1rem 2rem', width: '80%', margin: "auto",
    fontFamily: 'Poppins'
}},h1, div1, div2, div3);
